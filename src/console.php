...
$console
    ...
    ->setCode(function (InputInterface $input, OutputInterface $output) use ($app) {
		...
		foreach($tables as $table_name => $table){
			...
			@mkdir(__DIR__."/../web/routes/".$TABLENAME, 0755);
			@mkdir(__DIR__."/../web/views/".$TABLENAME, 0755);

			$fp = fopen(__DIR__."/../web/routes/".$TABLENAME."/index.php", "w+");
			...
			$fp = fopen(__DIR__."/../web/routes/base.php", "w+");
...
EOT
    ...
    ->setCode(function (InputInterface $input, OutputInterface $output) use ($app) {
        ...
        if (empty($table)) {
            throw new \Symfony\Component\CssSelector\Exception\ExpressionErrorException("Table name undefined.");
        }
...
//        fclose($fp);
//
//        print "\tArchivo " . __DIR__."/../web/routes/base.php" . " creado con exito.\n";

//		$fp = fopen(__DIR__."/../web/views/menu.html.twig", "w+");
//		fwrite($fp, $_menu_template);
//		fclose($fp);
//
//		print "\tArchivo " . __DIR__."/../web/views/menu.html.twig" . " creado con exito.\n\n";
