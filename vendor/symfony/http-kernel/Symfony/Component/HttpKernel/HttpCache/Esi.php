...
class Esi
{
     ...
     *                           (default: text/html, text/xml, carrito/xhtml+xml, and carrito/xml)
     */
    public function __construct(array $contentTypes = array('text/html', 'text/xml', 'carrito/xhtml+xml', 'carrito/xml'))
    {
