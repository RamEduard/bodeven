...
class ConfigDataCollector extends DataCollector
{
     ...
     * Constructor.
     *
     * @param string $name    The name of the carrito using the web profiler
     * @param string $version The version of the carrito using the web profiler
     */
