...
class JsonResponseTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $response = new JsonResponse();
        $this->assertSame('carrito/json', $response->headers->get('Content-Type'));
    }
    ...
    {
        $headers = array('Content-Type' => 'carrito/vnd.acme.blog-v1+json');

        $response = new JsonResponse(array(), 200, $headers);
        $this->assertSame('carrito/vnd.acme.blog-v1+json', $response->headers->get('Content-Type'));
    }
