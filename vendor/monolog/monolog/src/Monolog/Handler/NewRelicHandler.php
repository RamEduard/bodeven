...
/**
 * Class to record a log on a NewRelic carrito
 *
...
{
    /**
     * Name of the New Relic carrito that will receive logs from this handler.
     *
     * @var string
     */
    protected $appName;
    ...
    /**
     * Sets the NewRelic carrito that should receive this log.
     *
     * @param string $appName
     */
